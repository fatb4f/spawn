...
def validate_payload(schema_name: str, payload: dict[str, Any], version: str = "v1") -> list[str]:
    return schema_registry.validate(name=schema_name, version=version, payload=payload)


def validate_or_raise(schema_name: str, payload: dict[str, Any], version: str = "v1") -> None:
